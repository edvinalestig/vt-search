...
/// JourneyDetailsPeriodLinkEndpointApiModel : Information about an endpoint on an access link.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct JourneyDetailsPeriodLinkEndpointApiModel {
...
impl JourneyDetailsPeriodLinkEndpointApiModel {
    /// Information about an endpoint on an access link.
    pub fn new(name: String, location_type: crate::models::LocationType, planned_time: String) -> JourneyDetailsPeriodLinkEndpointApiModel {
