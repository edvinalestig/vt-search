...
/// JourneysPeriodDepartureAccessLinkApiModel : Information about a walk, bike or car link from origin to first public transport trip leg.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct JourneysPeriodDepartureAccessLinkApiModel {
    ...
    pub origin: Option<Box<crate::models::JourneysPeriodLinkEndpointApiModel>>,
    #[serde(rename = "destination", skip_serializing_if = "Option::is_none")]
    pub destination: Option<Box<crate::models::JourneysPeriodCallApiModel>>,
    ...
    pub segments: Option<Option<Vec<crate::models::JourneysPeriodLinkSegmentApiModel>>>,
}

impl JourneysPeriodDepartureAccessLinkApiModel {
    /// Information about a walk, bike or car link from origin to first public transport trip leg.
    pub fn new() -> JourneysPeriodDepartureAccessLinkApiModel {
