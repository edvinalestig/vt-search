...
pub struct DeparturesAndArrivalsPeriodArrivalApiModel {
...
impl DeparturesAndArrivalsPeriodArrivalApiModel {
    pub fn new(stop_point: crate::models::DeparturesAndArrivalsPeriodStopPointApiModel, planned_time: String) -> DeparturesAndArrivalsPeriodArrivalApiModel {
