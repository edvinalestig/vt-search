...
/// JourneyDetailsPeriodDestinationLinkApiModel : Information about a walk, bike or car link from origin to destination.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct JourneyDetailsPeriodDestinationLinkApiModel {
    ...
    pub destination: Option<Box<crate::models::JourneyDetailsPeriodLinkEndpointApiModel>>,
...
impl JourneyDetailsPeriodDestinationLinkApiModel {
    /// Information about a walk, bike or car link from origin to destination.
    pub fn new() -> JourneyDetailsPeriodDestinationLinkApiModel {
