...
/// JourneysPeriodCallApiModel : Information about a call on the trip leg.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct JourneysPeriodCallApiModel {
    #[serde(rename = "stopPoint")]
    pub stop_point: Box<crate::models::JourneysPeriodStopPointApiModel>,
...
impl JourneysPeriodCallApiModel {
    /// Information about a call on the trip leg.
    pub fn new(stop_point: crate::models::JourneysPeriodStopPointApiModel, planned_time: String) -> JourneysPeriodCallApiModel {
