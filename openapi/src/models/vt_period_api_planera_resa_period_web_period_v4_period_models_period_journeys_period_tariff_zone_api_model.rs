...
pub struct JourneysPeriodTariffZoneApiModel {
...
impl JourneysPeriodTariffZoneApiModel {
    pub fn new() -> JourneysPeriodTariffZoneApiModel {
        JourneysPeriodTariffZoneApiModel {
            gid: None,
            name: None,
            number: None,
            short_name: None,
