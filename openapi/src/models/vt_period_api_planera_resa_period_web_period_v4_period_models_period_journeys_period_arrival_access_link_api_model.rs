...
/// JourneysPeriodArrivalAccessLinkApiModel : Information about a walk, bike or car link from last public transport trip leg to destination.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct JourneysPeriodArrivalAccessLinkApiModel {
    ...
    pub origin: Option<Box<crate::models::JourneysPeriodCallApiModel>>,
    #[serde(rename = "destination", skip_serializing_if = "Option::is_none")]
    pub destination: Option<Box<crate::models::JourneysPeriodLinkEndpointApiModel>>,
...
impl JourneysPeriodArrivalAccessLinkApiModel {
    /// Information about a walk, bike or car link from last public transport trip leg to destination.
    pub fn new() -> JourneysPeriodArrivalAccessLinkApiModel {
