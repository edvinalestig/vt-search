...
/// JourneysPeriodDestinationLinkApiModel : Information about a walk, bike or car link from origin to destination.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct JourneysPeriodDestinationLinkApiModel {
...
impl JourneysPeriodDestinationLinkApiModel {
    /// Information about a walk, bike or car link from origin to destination.
    pub fn new() -> JourneysPeriodDestinationLinkApiModel {
